...
this_program_name="mmrproteffect-test.sh"
...
${this_program_name}: run integration/regression tests for mmrproteffect 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/mmrproteffect -d data/tests
