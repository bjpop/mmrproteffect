var attributes_labels = {
    ...
    'revel_score': 'Conservation Score REVEL',
    'maxentscan_alt': 'maxentscan_alt',
    'maxentscan_diff': 'maxentscan_diff',
    'maxentscan_ref': 'maxentscan_ref',
    'gnomad_af': 'gnomAD Population Frequency',
    'num_homozygotes': 'Number of gnomAD homozygotes',
    'mtr': 'Missense Tolerance Ratio',
    'mtr_genemean': 'mtr_genemean',
    'mtr_genemedian': 'mtr_genemedian',
    'diff_mtr_gene_mean': 'diff_mtr_gene_mean',
    'diff_mtr_gene_median': 'diff_mtr_gene_median',
    'diff_mtr_genome_mean': 'diff_mtr_genome_mean',
    'diff_mtr_genome_median': 'diff_mtr_genome_median',
    'ratio_mtr_gene_mean': 'ratio_mtr_gene_mean',
    'ratio_mtr_gene_median': 'ratio_mtr_gene_median',
    'ratio_mtr_genome_mean': 'ratio_mtr_genome_mean',
    'ratio_mtr_genome_median': 'ratio_mtr_genome_median',
    'ToPRO': 'ToPRO',
    'ToGLY': 'ToGLY',
    'FromPRO': 'FromPRO',
    'FromGLY': 'FromGLY',
    ...
    'Psi': 'Psi',
    'Omega': 'Omega',
    'PositivePhiGLY': 'PositivePhiGLY',
    'provean': 'Conservation Score Provean',
    'provean_pred': 'provean_pred',
    'sift': 'Conservation Score SIFT',
    'sift_pred': 'sift_pred',
    'dist_lig': 'Distance to Ligand',
    'dist_na': 'Distance to NA',
    'dist_ppi': 'Distance to PPI Interface',
    'pph2': 'Damaging Score PolyPhen2',
    'pph2_prediction': 'pph2_prediction',
    'mcsm_na': 'DDG Affinity mCSM-NA',
    'mcsm_ppi': 'DDG Affinity mCSM-PPI',
    'ddg_encom': 'DDG Stability ENCoM',
    'dds_encom': 'DDS Vibrational Entropy ENCoM',
    'ddg_duet': 'DDG Stability DUET',
    'ddg_dynamut': 'DDG Stability DynaMut',
    'ddg_mcsm': 'DDG Stability mCSM',
    'ddg_sdm': 'DDG Stability SDM',
...
function histogram_one_variable(gene_symbol, x_axis_attribute, variant_info) {
    ...
    var layout = {
        title: {
            text: attributes_labels[x_axis_attribute],
        },
        yaxis: {
            autorange: true,
            title: "count",
        ...
        xaxis: {
            title: attributes_labels[x_axis_attribute],
            type: 'category',
        },
        height: 600,
    };
